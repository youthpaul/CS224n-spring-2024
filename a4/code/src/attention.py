...
def precompute_rotary_emb(dim, max_positions):
    ...
    # Initailize the RoPE tensor
    rope_cache = torch.arange(max_positions)[..., None, None].expand(-1, dim // 2, 2) # (max_positions, dim/2, 2)
...
def apply_rotary_emb(x, rope_cache):
    ...
    rope_cache = rope_cache[None, None, ...] # (1, 1, l, d // 2, 2)
